      ...
      <div className="container px-4 sm:px-6">
        <div className="relative rounded-3xl overflow-hidden">
          ...
          <div className="absolute inset-0">
            <img src="/luxury-real-estate-interior-modern.jpg" alt="CTA Background" className="w-full h-full object-cover" />
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-primary-foreground/90 max-w-2xl mx-auto mb-10 text-balance leading-relaxed">
              Let our expert team guide you through every step of your real estate journey. Schedule a consultation
              today.
            </p>
